...
namespace LocalizerGUI
{
    ...
    internal class OpenAIService
    {
        ...
        // Holds the key for the translation file
        private const string TranslationKey = "Key,File,Type,UsedInMainMenu,NoTranslate,english,Context / Alternate Text,german,spanish,french,italian,japanese,koreana,polish,brazilian,russian,turkish,schinese,tchinese";
        ...
        public async Task TranslateAsync()
        {
            ...
            NewFile.Insert(0, new Entry() { EnglishText = TranslationKey});
