...
namespace LocalizerGUI
{
    ...
    internal class OpenAIService
    {
        ...
        private const string TranslationInstructions = "For each word or phrase that you receive, you will translate it into several languages. After each full translation of the word or phrase, place a comma and then continue with the remainder of the languages without adding a line break. These are the languages and the output format: german,spanish,french,italian,japanese,koreana,polish,brazilian,russian,turkish,simplified chinese, and traditional chinese. You will respond with only the correctly translated and formatted output.";
